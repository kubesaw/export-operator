...
# example.com/snapshot-operator-bundle:$VERSION and example.com/snapshot-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/kubesaw/export-operator
...
IMG ?= quay.io/kubesaw/export-operator:v0.0.11
